<%@ WebHandler Language="C#" Class="GaleriaDeArte.CImage" %>
...
namespace GaleriaDeArte
{
    public class CImage : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            string codigo =  context.Request.QueryString["codigo"];
...
namespace GaleriaDeArte
{
    ...
    public class RandomImage
    {
        ...
        private void GenerateImage()
        {
            ...
            path.AddString(this.text.ToString().Trim(), font.FontFamily, (int)font.Style, 65, rect, format);
            float v = 4F;
            PointF[] points =
            {
